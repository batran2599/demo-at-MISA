class Dialog_tdb {
    ...
    /**
     * Xét các validate tre và xá style cảnh báo khi validate employeed hợp lệ
     * CreatedBy: Trần Duy Bá
     */
    setValidateTrueForEmployeeCode() {
    ...
    /**
     * Xét các validate false và style cảnh báo khi validate employeed không hợp lệ
     * CreatedBy: Trần Duy Bá
     */
    setValidateFalseForEmployeeCode() {
    ...
    checkEmployeeCode() {
        $(".input-dialog > input[name='employeeCode']").change(()=>{
            if(!/NV[0-9]+/.test($(".input-dialog > input[name='employeeCode']").val())) {
                ...
                this.setValidateFalseForEmployeeCode();
                ...
                $.ajax({
                    ...
                    if(res != undefined && res != null) {
                        ...
                        this.setValidateTrueForEmployeeCode();
                    }
                }).fail(()=>{
